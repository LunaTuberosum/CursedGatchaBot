...
sequelize.sync({ force }).then(async () => {
	...
	const shop = [
		...
		ItemShop.upsert({ name: 'LIGHTNING GEM', emoji: ":large_orange_diamond:", itemCost: "POKEDOLLAR", cost: 0, description: "A crystalized gem of Lightning energy." }),
		...
		ItemShop.upsert({ name: 'METAL GEM', emoji: ":large_orange_diamond:", itemCost: "POKEDOLLAR", cost: 0, description: "A crystalized gem of Metal energy." }),
		...
		ItemShop.upsert({ name: 'COLORLESS GEM', emoji: ":large_orange_diamond:", itemCost: "POKEDOLLAR", cost: 0, description: "A crystalized gem of Normal energy." }),
